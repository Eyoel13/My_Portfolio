...
// 1. Cursor Engine (High Z-Index & Centered)
...
function openModal(id) {
  ...
  // Visit button logic - styled to appear next to the title
  const visitButton = data.link
    ? `<a href="${data.link}" target="_blank" class="see-more" style="margin: 0; text-decoration: none;">Visit Site</a>`
    : "";
  ...
  // Refresh cursor hover listeners for the new modal buttons
  addHover();
}
